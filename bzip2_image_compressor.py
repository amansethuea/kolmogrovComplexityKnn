...
class ImageClassification(object):
    ...
    def calculate_ncd(self, x_1, x_2):
        ...
        c_x1 = bz2.compress(x_1, compresslevel=self.compression_level)
        # compression of image file 2
        c_x2 = bz2.compress(x_2, compresslevel=self.compression_level)
        # Compression of concatenated images c(x_1 + x_2)
        c_x1_x2 = bz2.compress(x1_x2, compresslevel=self.compression_level)
